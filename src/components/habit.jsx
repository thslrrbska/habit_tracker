...
class Habit extends PureComponent {
  componentDidMount() {
    console.log(`habit: ${this.props.habit.name} mouted`);
  }
    ...
    return (
      <>
        <li className="habit">
          ...
          <button className="habit-button habit-decrease" onClick={this.handleDerement}><i className='fas fa-minus-square'></i></button>
